...
class Sim:
    def __init__(self, market_data: List[MdUpdate], features_dict: Dict, execution_latency: float, md_latency: float) -> None:
    ...
    def tick(self) -> Tuple[float, List[Union[OwnTrade, MdUpdate]], List]:
        while True:
        ...
        features = self.features_dict.get(key.to_numpy(), None)
        return key, res, features
